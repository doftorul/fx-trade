...
from fxtrade.strategy.interface import IStrategy
# Import Default-Strategy to have hyperopt correctly resolve
from fxtrade.strategy.default_strategy import DefaultStrategy  # noqa: F401
...
def import_strategy(strategy: IStrategy, config: dict) -> IStrategy:
    ...
    of fxtrade.strategy and returns an instance of it
    """
    ...
    # Adjust module name
    attr['__module__'] = 'fxtrade.strategy'
