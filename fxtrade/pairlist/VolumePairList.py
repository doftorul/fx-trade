...
class VolumePairList(IPairList):
    ...
    def __init__(self, fxtrade, config: dict) -> None:
        super().__init__(fxtrade, config)
        ...
        if not self._fxtrade.exchange.exchange_has('fetchTickers'):
            raise OperationalException(
    ...
    def _gen_pair_whitelist(self, base_currency: str, key: str) -> List[str]:
        ...
        tickers = self._fxtrade.exchange.get_tickers()
