...
from fxtrade.configuration import Configuration
from fxtrade.data.history import load_data
from fxtrade.optimize import get_timeframe
from fxtrade.optimize.backtesting import Backtesting
from fxtrade.state import RunMode
from fxtrade.resolvers import HyperOptResolver
...
def start(args: Namespace) -> None:
    ...
    logger.info('Starting fxtrade in Hyperopt mode')
    ...
    if config.get('strategy') and config.get('strategy') != 'DefaultStrategy':
        ...
        logger.error(
            ...
            "https://github.com/fxtrade/fxtrade/blob/develop/docs/hyperopt.md "
