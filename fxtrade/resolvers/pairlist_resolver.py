...
from fxtrade.pairlist.IPairList import IPairList
from fxtrade.resolvers import IResolver
...
class PairListResolver(IResolver):
    ...
    def __init__(self, pairlist_name: str, fxtrade, config: dict) -> None:
        """
        Load the custom class from config parameter
        :param config: configuration dictionary or None
        """
        self.pairlist = self._load_pairlist(pairlist_name, kwargs={'fxtrade': fxtrade,
                                                                   'config': config})
